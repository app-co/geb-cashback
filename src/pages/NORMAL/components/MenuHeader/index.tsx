      ...
      <S.main>
        ...
        <S.content>
          <HStack space={4}>
            ...
            <Eye weight="duotone" size={`${canvaPercent("4.5")}px`} />
            <Question weight="duotone" size={`${canvaPercent("4.5")}px`} />

            <TouchableOpacity onPress={() => nav.navigate("invit")}>
              <UsersThree weight="duotone" size={`${canvaPercent("4.5")}px`} />
            </TouchableOpacity>

            <TouchableOpacity onPress={() => nav.navigate("profile")}>
              <UserCircle weight="duotone" size={`${canvaPercent("4.5")}px`} />
            </TouchableOpacity>
          </HStack>
        </S.content>
      </S.main>
